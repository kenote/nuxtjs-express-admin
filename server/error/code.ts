...
export default <CodeTypes> {
  ...
  ERROR_VALID_EXCHANGE_REQUIRED: 1409,
  ERROR_VALID_EXCHANGE_NULL: 1410,
  ERROR_VALID_EXCHANGE_TYPE: 1411,
  ERROR_VALID_EXCHANGE_USED: 1412,
  ERROR_VALID_EXCHANGE_EXPIRED: 1413,
}
