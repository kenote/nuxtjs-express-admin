export interface MessageTypes {
  ...
  ERROR_VALID_EXCHANGE_REQUIRED: string
  ERROR_VALID_EXCHANGE_NULL: string
  ERROR_VALID_EXCHANGE_TYPE: string
  ERROR_VALID_EXCHANGE_USED: string
  ERROR_VALID_EXCHANGE_EXPIRED: string
}