export interface CodeTypes {
  ...
  ERROR_VALID_EXCHANGE_REQUIRED: number
  ERROR_VALID_EXCHANGE_NULL: number
  ERROR_VALID_EXCHANGE_TYPE: number
  ERROR_VALID_EXCHANGE_USED: number
  ERROR_VALID_EXCHANGE_EXPIRED: number
}